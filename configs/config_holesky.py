...
CS_MODULE_MODULE_FEE_BP = 700
CS_MODULE_TREASURY_FEE_BP = 300
CS_MODULE_TARGET_SHARE_BP = 1500
CS_MODULE_PRIORITY_EXIT_SHARE_THRESHOLD = 2000
...
CSM_COMMITTEE_MS = "0xc4DAB3a3ef68C6DFd8614a870D64D475bA44F164"  # EOA
...
CSM_IMPL_V2_ADDRESS = "0x3eb7E77f733619651Fd0604D82d0674c0dD656ba"
CS_ACCOUNTING_IMPL_V2_ADDRESS = "0x1eB88A7Ba6d84D61558BD7692d61EA4A01E33c10"
CS_FEE_DISTRIBUTOR_IMPL_V2_ADDRESS = "0xE5E8FdB923a301a3dD17e9D3a67f8754449be439"
CS_FEE_ORACLE_IMPL_V2_ADDRESS = "0xdD7B4e28C08594A1872Bc7d2eFBAA62d7AFBe2Bf"
CS_GATE_SEAL_V2_ADDRESS = "0xB508c296a68E20D3823C96B1D97a7650F97A5E0C"
CS_VERIFIER_V2_ADDRESS = "0x2aacBbef660ff8E3dA8C864D1B34191A4010394F"
CS_PERMISSIONLESS_GATE_ADDRESS = "0xD029E8Cd1a269baE62262a5713496d4c029511F0"
CS_VETTED_GATE_ADDRESS = "0x2de9127cC9dbf8DF46E7E7a91ac3aA21123a3e13"
CS_EXIT_PENALTIES = "0xa6ad84E6712aCB32A2319665baA8f22f9467fbF7"
CS_EJECTOR_ADDRESS = "0xAcC55275DF98f97C4E0d5300FB59228940CA1b71"
CS_STRIKES_ADDRESS = "0x6ee3f3650C0dec416608fE989180D3C69dE438E0"
CS_SET_VETTED_GATE_TREE_FACTORY = "0x0000000000000000000000000000000000000000"
CS_DEFAULT_BOND_CURVE = (
    [1, ETH(2)], [2, ETH(1.9)], [3, ETH(1.8)], [4, ETH(1.7)], [5, ETH(1.6)], [6, ETH(1.5)]
)
CS_LEGACY_EA_BOND_CURVE = (
    ([1, ETH(1.5)], [2, ETH(1.9)], [3, ETH(1.8)], [4, ETH(1.7)], [5, ETH(1.6)], [6, ETH(1.5)])
)
CS_EXTRA_CURVES = [
    ([1, ETH(3)], [2, ETH(1.9)], [3, ETH(1.8)], [4, ETH(1.7)], [5, ETH(1.6)], [6, ETH(1.5)]),
    ([1, ETH(4)], [2, ETH(1)],)
]
CS_CURVES = [CS_DEFAULT_BOND_CURVE, CS_LEGACY_EA_BOND_CURVE, *CS_EXTRA_CURVES]
CS_ICS_GATE_BOND_CURVE = ([1, ETH(1.5)], [2, ETH(1.3)])
CS_ORACLE_EPOCHS_PER_FRAME = 225 * 7  # 7 days
