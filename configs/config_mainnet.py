...
GATE_SEAL_EXPIRY_TIMESTAMP = 1772323200  # 2026-03-01 00:00GMT
...
DUAL_GOVERNANCE_VALUES = {
    ...
    "MIN_TIEBREAKER_ACTIVATION_TIMEOUT": 15768000, # 180 days
    "MAX_SEALABLE_WITHDRAWAL_BLOCKERS_COUNT": 255,
    "PROPOSERS_COUNT": 1,
    "TIEBREAKER_DETAILS": {
        "TIEBREAKER_COMMITTEE": "0x175742c3DDD88B0192df3EcF98f180A79cb259D0",
        "TIEBREAKER_DURATION": 31536000, # 1 year
        "WITHDRAWAL_BLOCKERS": (
...
TIEBREAKER_VALUES = {
    "CORE_COMMITTEE": {
        "ADDRESS": "0x175742c3DDD88B0192df3EcF98f180A79cb259D0",
    ...
    "SUB_COMMITTEES": [
        {
            "ADDRESS": "0x74836470337Ba5d2a92fe16E44AD862E28fcf9B3",
            "OWNER": DUAL_GOVERNANCE_EXECUTORS[0],
            "MEMBERS": (
        ...
        {
            "ADDRESS": "0x7dAdae4e1a0DB43F6bcfA75295666fc044605679",
            "OWNER": DUAL_GOVERNANCE_EXECUTORS[0],
            "MEMBERS": (
