...
NODE_OPERATORS_REGISTRY_IMPL_V1 = (
    "0x5d39ABaa161e622B99D45616afC8B837E9F19a25"  # was used in archived tests
)
...
EASYTRACK_SIMPLE_DVT_SUBMIT_VALIDATOR_EXIT_REQUEST_HASHES_FACTORY = (
...
CS_FEE_ORACLE_CONSENSUS_VERSION = (
    4  # SRV3: set by FeeOracle.finalizeUpgradeV3(consensusVersion)
)
CS_MODULE_ID = 3
...
DEPOSIT_SECURITY_MODULE_V2 = (
    "0xC77F8768774E1c9244BEed705C4354f2113CFc09"  # dsm address before SR V2 enact
)
...
TOP_UP_GATEWAY_TARGET_BALANCE_GWEI = (
    2_046_750_000_000  # 2046.75 ETH (1.25 ETH margin below MaxEB)
)
...
SR_MODULES_FEE_BP = (
    ...
    * (100_00 - SIMPLE_DVT_MODULE_TARGET_SHARE_BP - CS_MODULE_TARGET_SHARE_BP)
...
CS_PERMISSIONLESS_GATE_ADDRESS = (
    "0xe29eaE1f3A3D0eDD45Bd6D4248A38F603f1F4d1A"  # SRV3 newPermissionlessGate
)
