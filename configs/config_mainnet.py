...
CURATED_MANAGE_SIGNING_KEYS_HOLDERS = {
    # NO id: address map
    21: "0xF45C77EadD434612fCD93db978B3E36B0D58eC99",  # Consensys, granted by vote_2026_05_13
}
...
EASYTRACK_CURATED_SUBMIT_VALIDATOR_EXIT_REQUEST_HASHES_FACTORY = "0x4F716AD3Cc7A3A5cdA2359e5B2c84335c171dCde"
EASYTRACK_SIMPLE_DVT_SUBMIT_VALIDATOR_EXIT_REQUEST_HASHES_FACTORY = "0x58A59dDC6Aea9b1D5743D024E15DfA4badB56E37"
EASYTRACK_CS_SET_VETTED_GATE_TREE_FACTORY = "0xBc5642bDD6F2a54b01A75605aAe9143525D97308"
EASYTRACK_CSM_SET_MERKLE_GATE_TREE_FACTORY = "0xf3ec30B86c3dC1b8a1C754D885F9bE3160e15B4c"
EASYTRACK_CSM_REPORT_WITHDRAWALS_FOR_SLASHED_VALIDATORS_FACTORY = "0xE330516a03bDdEBA4209b5591112f1aa3dd90F0A"
EASYTRACK_CSM_SETTLE_GENERAL_DELAYED_PENALTY_FACTORY = "0xB71755bE764abB4Ce26cb4dADf056Be57fB8880F"
EASYTRACK_CM_SET_MERKLE_GATE_TREE_FACTORY = "0xa121667D1780a1D54EAEd67AE17ee13d0f872D60"
...
EASYTRACK_SET_DEPOSITS_RESERVE_TARGET_FACTORY = "0x62E9Dc68BDCBC46362f40e0bb9c154C9a42E62b0"
...
# Auxiliary addresses
LDO_HOLDER_ADDRESS_FOR_TESTS = "0x3e40D73EB977Dc6a537aF587D48316feE66E9C8c"
...
LIDO_LOCATOR_IMPL = "0x60E09F1791F1168d0450E4F100616B4a3F95119C"  # EDF
...
# Lido
LIDO_IMPL = "0x028271E30a695c0527A0C50cA30603feD004cDb0"  # SRV3
...
# set by finalizeUpgrade_v4 (upgrade-params-mainnet.toml [lido].depositsReserveTarget)
LIDO_DEPOSITS_RESERVE_TARGET = 1_500 * 10**18  # 1500 ETH  # SRV3
...
CURATED_STAKING_MODULE_OPERATORS_ACTIVE_COUNT = 35
...
# Curated Module v2 — added by the SRv3/CMv2 upgrade via StakingRouter.addStakingModule.
# Values mirror UpgradeConfig.getCuratedModuleConfig() (see core deployed-*.json `curatedModule`).
# It is appended after the existing 3 modules (Curated=1, SimpleDVT=2, CSM=3), so its id is 4.
CURATED_V2_STAKING_MODULE_ID = 4
CURATED_V2_STAKING_MODULE_ADDRESS = "0xDa5F930cE326EB5205085D66c72A4E79d60cB8C1"  # SRV3
CURATED_V2_STAKING_MODULE_NAME = "curated-onchain-v2"
CURATED_V2_STAKING_MODULE_TARGET_SHARE_BP = 10000
CURATED_V2_STAKING_MODULE_PRIORITY_EXIT_SHARE_THRESHOLD = 10000
CURATED_V2_STAKING_MODULE_MODULE_FEE_BP = 400
CURATED_V2_STAKING_MODULE_TREASURY_FEE_BP = 600
CURATED_V2_STAKING_MODULE_MAX_DEPOSITS_PER_BLOCK = 100
CURATED_V2_STAKING_MODULE_MIN_DEPOSITS_BLOCK_DISTANCE = 75
CURATED_V2_ACCOUNTING = "0x2F91e3A8C5d6593bf4F8403fCfeCcd62dF59f6F6"  # SRV3
CURATED_V2_FEE_ORACLE = "0x8EeFCdbD984c30E472BcbF545783D051CB5114e5"  # SRV3
CURATED_V2_VERIFIER = "0xC392F457960f1B13Ebaf1aa6C065479dD507E1E3"  # SRV3
CURATED_V2_EJECTOR = "0xe181A377A2d2BDE9A83f1474BC3DB7A412de091E"  # SRV3
CURATED_V2_FEE_DISTRIBUTOR = "0x367d23c756599c20DCc8D6943F4976E8F88D60d7"
CURATED_V2_HASH_CONSENSUS = "0x902D64c93F6595339aA46105627a085591051aFb"
CURATED_V2_META_REGISTRY_ADDRESS = "0xA64b339eebD3dC3De848298B6a140955932901d8"
CURATED_V2_PARAMETERS_REGISTRY = "0xffC1C5d59CeAC6F6c27E701F04a70cb50474607C"
CURATED_V2_STRIKES = "0xf4618370a1fBf46905B16C10817c8CFaD924D6db"
...
CURATED_V2_COMMITTEE_MS = "0x2570e0b22AD904501dfB0d49575991ACB801dD91"
# CuratedModuleConfig.circuitBreakerPauser — the vote registers it as pauser
# for all five CM v2 pausables on the CircuitBreaker
CURATED_V2_CIRCUIT_BREAKER_PAUSER = CURATED_V2_COMMITTEE_MS  # SRV3
...
CS_FEE_ORACLE_CONSENSUS_VERSION = 4  # SRV3: set by FeeOracle.finalizeUpgradeV3(consensusVersion)
CS_MODULE_ID = 3
...
ORACLE_REPORT_SANITY_CHECKER = "0x147f8d3cf3004FAf9Bf94E88B54b6C06De507be9"  # SRV3
...
EXITED_ETH_AMOUNT_PER_DAY_LIMIT = 57600
APPEARED_ETH_AMOUNT_PER_DAY_LIMIT = 57600
MAX_BALANCE_EXIT_REQUESTED_PER_REPORT_IN_ETH = 19200
MAX_EFFECTIVE_BALANCE_WEIGHT_WC_TYPE_01 = 32
MAX_EFFECTIVE_BALANCE_WEIGHT_WC_TYPE_02 = 2048
MAX_CL_BALANCE_DECREASE_BP = 360
CONSOLIDATION_ETH_AMOUNT_PER_DAY_LIMIT = 93375
EXITED_VALIDATOR_ETH_AMOUNT_LIMIT = 32
EXTERNAL_PENDING_BALANCE_CAP_ETH = 300
...
DEPOSIT_SECURITY_MODULE = "0x39BB5d491e98A44D1bfe8047A737a81E296a63E0"  # EDF (DSM v5)
DEPOSIT_SECURITY_MODULE_V4 = "0xF573E9E3de1f86B085417ab294f56E7920B4e9Be"  # SRV3, dsm address before EDF enact
...
## EDF DelegationContracts of the guardians (moved from EOA hot keys by the EDF vote),
## in the order of DepositSecurityModule.getGuardians()
DSM_GUARDIANS = [
    "0x915F0Fa50E1af761B113b41c79ab33Bf4734C36E",  # Lido dev team
    "0xe387Ba1d5C9f6306eCe9ac949C7fB6233dD5411E",  # P2P
    "0x35506190Ca6df385aA6Bc4a970646dd4f49426c1",  # Staking Facilities
    "0xDc1579636686C082fc3b00B9EB25259A110D0C44",  # Blockscape
    "0x031E597BcF680f1f2293b119b4b2B14096B15497",  # Stake.fish
    "0x6A22d74a816662078f2371A7138E7614874cd61d",  # Stakely (replaced Kiln)
]
...
ACCOUNTING_ORACLE_IMPL = "0xe4f03D1107d1905B6F2A28FCb6Af221E0CE19136"  # SRV3
HASH_CONSENSUS_FOR_AO = "0xD624B08C83bAECF0807Dd2c6880C3154a5F0B288"
AO_EPOCHS_PER_FRAME = 225
AO_FAST_LANE_LENGTH_SLOTS = 100
# set by finalizeUpgrade_v5 (upgrade-params-mainnet.toml [accountingOracle].consensusVersion)
AO_CONSENSUS_VERSION = 6  # SRV3

# ValidatorsExitBusOracle
VALIDATORS_EXIT_BUS_ORACLE = "0x0De4Ea0184c2ad0BacA7183356Aea5B8d5Bf5c6e"
VALIDATORS_EXIT_BUS_ORACLE_IMPL = "0x2C3386b39db89eef0F362A3BE0C05a6811E809E3"  # SRV3
HASH_CONSENSUS_FOR_VEBO = "0x7FaDB6358950c5fAA66Cb5EB8eE5147De3df355a"
VEBO_EPOCHS_PER_FRAME = 45
VEBO_FAST_LANE_LENGTH_SLOTS = 100
VEBO_CONSENSUS_VERSION = 5  # SRV3 (finalizeUpgrade_v3)
MAX_VALIDATORS_PER_REPORT = 600
MAX_EXIT_REQUESTS_LIMIT = 11200
EXITS_PER_FRAME = 1
FRAME_DURATION_IN_SEC = 48
# VEBO exit-balance rate limit, set by finalizeUpgrade_v3 (upgrade-params-mainnet.toml [validatorsExitBusOracle])
VEBO_MAX_EXIT_BALANCE_ETH = 358400
VEBO_BALANCE_PER_FRAME_ETH = 32


# AccountingOracle and ValidatorsExitBusOracle
## Migrated from LidoOracle (LegacyOracle)
ORACLE_QUORUM = 5
# EDF DelegationContracts of the oracle members (moved from EOA hot keys by the EDF vote),
# in the order of HashConsensus.getMembers() after the rotation
ORACLE_COMMITTEE = (
    ...
    "0x56B3eA8016Da18C6E8CD8135492d242F0dE0DBBC",  # Chorus One
...
WITHDRAWAL_VAULT_IMPL = "0xfB4521BD151BFB45DB6045D2d07e58e0f597e340"  # SRV3
...
STAKING_ROUTER_IMPL = "0xDD76927045435C7605cf6f5F978cfb8CABDb5F80"  # SRV3
STAKING_ROUTER_VERSION = 4  # SRV3
# Global per-block top-up cap (in Gwei), set by StakingRouter.finalizeUpgrade_v4
STAKING_ROUTER_MAX_TOP_UP_PER_BLOCK_GWEI = 3200000000000  # SRV3

# TopUpGateway
TOP_UP_GATEWAY = "0x3FC2C71579D80790Aaa3fc7Be8B66ac39dC57374"  # SRV3
TOP_UP_GATEWAY_IMPL = "0xb08dBc68C521cD7A4318dc4C807a42bEB20f1106"  # SRV3
# initialize() params — upgrade-params-mainnet.toml [topUpGateway]
TOP_UP_GATEWAY_MAX_VALIDATORS_PER_TOP_UP = 32
TOP_UP_GATEWAY_MIN_BLOCK_DISTANCE = 75
TOP_UP_GATEWAY_MAX_ROOT_AGE = 600  # seconds
TOP_UP_GATEWAY_TARGET_BALANCE_GWEI = 2_046_750_000_000  # 2046.75 ETH (1.25 ETH margin below MaxEB)
TOP_UP_GATEWAY_MIN_TOP_UP_GWEI = 2_000_000_000  # 2 ETH
# sole TOP_UP_ROLE holder, the depositor bot EDF DelegationContract (moved from the EOA by the EDF vote)
TOP_UP_GATEWAY_DEPOSITOR = "0x6Aa249bA53A3abcaC52F91146583B3eE2Ee4C7F5"
...
CONSOLIDATION_GATEWAY_MAX_REQUESTS_LIMIT = 2900  # SRV3
CONSOLIDATION_GATEWAY_CONSOLIDATIONS_PER_FRAME = 1  # SRV3
CONSOLIDATION_GATEWAY_FRAME_DURATION_IN_SEC = 30  # SRV3

# ConsolidationBus
CONSOLIDATION_BUS = "0xd907CE33B4Be423823d1CFFe80BD147E8b8554C8"  # SRV3
CONSOLIDATION_BUS_IMPL = "0xFfDe8Acab9D7037f29198Ad03ad6d05bac8B0a2E"  # SRV3
# initialize() params — upgrade-params-mainnet.toml [consolidationBus]
CONSOLIDATION_BUS_BATCH_SIZE = 200  # SRV3
CONSOLIDATION_BUS_MAX_GROUPS_IN_BATCH = 10  # SRV3
CONSOLIDATION_BUS_EXECUTION_DELAY = 86400  # SRV3 (seconds)

# ConsolidationMigrator — Curated (id 1) -> Curated Module v2 (id 4) migration
CONSOLIDATION_MIGRATOR = "0x9Dc70b5A4f4F5E4AF9058C983D560564F031f1D7"  # SRV3
CONSOLIDATION_MIGRATOR_IMPL = "0x6Fb4c152F092373dD71f0C07C83c1E77406599aB"  # SRV3
CONSOLIDATION_SOURCE_MODULE_ID = 1  # SRV3
CONSOLIDATION_TARGET_MODULE_ID = 4  # SRV3 == CURATED_V2_STAKING_MODULE_ID
# Curated Module Committee (CMC) multisig — stable deploy input from the toml
CONSOLIDATION_COMMITTEE = "0x2570e0b22AD904501dfB0d49575991ACB801dD91"  # SRV3
...
# GlobalConfig.circuitBreakerCommittee — the vote registers it as pauser for
# ConsolidationGateway / TopUpGateway
CIRCUIT_BREAKER_COMMITTEE = "0x8772E3a2D86B9347A2688f9bc1808A6d8917760C"  # SRV3
...
CS_VERIFIER_ADDRESS = "0xfce7aB839e55de77730716D05b3553e45ab3A5Ba"  # SRV3 newVerifier
CS_VERIFIER_ADDRESS_OLD = "0xdC5FE1782B6943f318E05230d688713a560063DC"
...
CS_EJECTOR_ADDRESS = "0x610B517D380f287c239C93F8eF6FfBd567AA4bA5"  # SRV3
CS_VETTED_GATE_ADDRESS = "0xB314D4A76C457c93150d308787939063F4Cc67E0"
CS_PERMISSIONLESS_GATE_ADDRESS = "0xb8cd8F059Ad7a5dB8CAfDe34aAb007317F7156C8"  # SRV3 newPermissionlessGate
CS_PERMISSIONLESS_GATE_V3_ADDRESS = CS_PERMISSIONLESS_GATE_ADDRESS
CS_VERIFIER_V2_ADDRESS = "0xdC5FE1782B6943f318E05230d688713a560063DC"
CS_VERIFIER_V3_ADDRESS = CS_VERIFIER_ADDRESS
CS_IDENTIFIED_DVT_CLUSTER_GATE_ADDRESS = "0xa12760721A72A7199aB38059DA6690b9Cd4ed7B8"  # SRV3
CS_GATE_SEAL_V2_ADDRESS = "0xE1686C2E90eb41a48356c1cC7FaA17629af3ADB3"
CS_EJECTOR_V3_ADDRESS = CS_EJECTOR_ADDRESS
...
EMERGENCY_PROTECTED_TIMELOCK_VALUES = {
    ...
    "EMERGENCY_PROTECTION_DETAILS": (
        2592000,
        0,
        1813449600,
    ),  # end-date extended by vote_2026_05_13
}
...
ACCOUNTING_IMPL = "0x3aa937Ac2ab89CDd363EdC6b5A4d4A42dF5bc043"  # SRV3
