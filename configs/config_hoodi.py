...
SANDBOX_IMPL = "0x95F00b016bB31b7182D96D25074684518246E42a"
...
# CSM staking router parameters
CS_MODULE_ID = 4
CS_MODULE_NAME = "Community Staking"
CS_MODULE_MODULE_FEE_BP = 600
CS_MODULE_TREASURY_FEE_BP = 400
CS_MODULE_TARGET_SHARE_BP = 1600
CS_MODULE_PRIORITY_EXIT_SHARE_THRESHOLD = 2100
...
ACCOUNTING_ORACLE_CONSENSUS_VERSION = 4  # updated from 3 to 4 after vote

# ValidatorsExitBusOracle
VALIDATORS_EXIT_BUS_ORACLE = "0x8664d394C2B3278F26A1B44B967aEf99707eeAB2"
VALIDATORS_EXIT_BUS_CONSENSUS_VERSION = 4  # added after vote

# CSOracle
CS_ORACLE_EPOCHS_PER_FRAME = 225 * 7  # 7 days
CS_ORACLE_CONSENSUS_VERSION = 3
...
CS_VERIFIER_ADDRESS = "0xf805b3711cBB48F15Ae2bb27095ddC38c5339968"
...
# Gate Seals
CS_GATE_SEAL_ADDRESS = "0x94a3aEB0E9148F64CB453Be2BDe2Bc0148f6AC24"
WITHDRAWAL_QUEUE_GATE_SEAL_ADDRESS = "0x73d76Bd3D589B2b2185c402da82cdAfbc18b958D"
TRIGGERABLE_WITHDRAWALS_GATE_SEAL_ADDRESS = "0x368f2fcb593170823cc844F1B29e75E3d26879A1"
...
ESCROW_VETO_SIGNALLING = "0x781afe6C8D768CEaA9a97f2A75714e80AE0e83B9"
...
TIEBREAKER_VALUES = {
    "CORE_COMMITTEE": {
        "ADDRESS": "0x9Ce4bA766C87cC87e507307163eA54C5003A3563",
    ...
    "SUB_COMMITTEES": [
        {
            "ADDRESS": "0xEd27F0d08630685A0cEFb1040596Cb264cf79f14",
            "QUORUM": 2,
            "OWNER": DUAL_GOVERNANCE_EXECUTORS[0],
            "MEMBERS": (
        ...
        {
            "ADDRESS": "0xE3e3c67997A4Db7d47ac7fa8ef81B677daBe5794",
            "QUORUM": 2,
            "OWNER": DUAL_GOVERNANCE_EXECUTORS[0],
            "MEMBERS": (
                "0x36c648351274bb4455ba6aAabF3F976824a93aF4",
        ...
        {
            "ADDRESS": "0xF4F16CB3B9E7a076E55c508035f25E606913Cc9d",
            "QUORUM": 2,
            "OWNER": DUAL_GOVERNANCE_EXECUTORS[0],
            "MEMBERS": (
                "0x36c648351274bb4455ba6aAabF3F976824a93aF4",
