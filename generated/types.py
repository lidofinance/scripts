...
class ACL(Contract): 
    ...
    def evalParams(self, _paramsHash: bytes32, _who: address, _where: address, _what: bytes32, _how: List[uint256],  tx_params) -> bool: ...
    ...
    def getPermissionParam(self, _entity: address, _app: address, _role: bytes32, _index: uint256,  tx_params) -> Tuple[uint8, uint8, uint240]: ...
    ...
    def grantPermissionP(self, _entity: address, _app: address, _role: bytes32, _params: List[uint256],  tx_params) -> None: ...
    ...
    def createPermission(self, _entity: address, _app: address, _role: bytes32, _manager: address,  tx_params) -> None: ...
...
class Finance(Contract): 
    ...
    def getEVMScriptExecutor(self, _script: bytes,  tx_params) -> address: ...
    def getPayment(self, _paymentId: uint256,  tx_params) -> Tuple[address, address, uint256, uint64, uint64, uint64, bool, uint64, address]: ...
    def getRecoveryVault(self,  tx_params) -> address: ...
    def getTransaction(self, _transactionId: uint256,  tx_params) -> Tuple[uint64, uint256, uint256, uint64, address, address, bool, uint64]: ...
    ...
    def newScheduledPayment(self, _token: address, _receiver: address, _amount: uint256, _initialPaymentTime: uint64, _interval: uint64, _maxExecutions: uint64, _reference: string,  tx_params) -> uint256: ...
    ...
    def newImmediatePayment(self, _token: address, _receiver: address, _amount: uint256, _reference: string,  tx_params) -> None: ... 
...
class Lido(Contract): 
    ...
    def initialize(self, depositContract: address, _oracle: address, _operators: address, _treasury: address, _insuranceFund: address,  tx_params) -> None: ...
    ...
    def setFeeDistribution(self, _treasuryFeeBasisPoints: uint16, _insuranceFeeBasisPoints: uint16, _operatorsFeeBasisPoints: uint16,  tx_params) -> None: ...
...
class Multicall2(Contract): 
    ...
    def tryBlockAndAggregate(self, requireSuccess: bool, calls: List[struct],  tx_params) -> Tuple[uint256, bytes32, List[struct]]: ... 
...
class NodeOperatorsRegistry(Contract): 
    ...
    def getNodeOperator(self, _id: uint256, _fullInfo: bool,  tx_params) -> Tuple[bool, string, address, uint64, uint64, uint64, uint64]: ...
    def canPerform(self, _sender: address, _role: bytes32, _params: List[uint256],  tx_params) -> bool: ...
    def getEVMScriptRegistry(self,  tx_params) -> address: ...
    def PUBKEY_LENGTH(self,  tx_params) -> uint256: ...
    ...
    def addSigningKeys(self, _operator_id: uint256, _quantity: uint256, _pubkeys: bytes, _signatures: bytes,  tx_params) -> None: ...
    ...
    def addSigningKeysOperatorBH(self, _operator_id: uint256, _quantity: uint256, _pubkeys: bytes, _signatures: bytes,  tx_params) -> None: ...
...
class TokenManager(Contract): 
    ...
    def getEVMScriptExecutor(self, _script: bytes,  tx_params) -> address: ...
    def getRecoveryVault(self,  tx_params) -> address: ...
    def getVesting(self, _recipient: address, _vestingId: uint256,  tx_params) -> Tuple[uint256, uint64, uint64, uint64, bool]: ...
    ...
    def assignVested(self, _receiver: address, _amount: uint256, _start: uint64, _cliff: uint64, _vested: uint64, _revokable: bool,  tx_params) -> uint256: ...
...
class Voting(Contract): 
    ...
    def getVote(self, _voteId: uint256,  tx_params) -> Tuple[bool, bool, uint64, uint64, uint64, uint64, uint256, uint256, uint256, bytes]: ...
    ...
    def initialize(self, _token: address, _supportRequiredPct: uint64, _minAcceptQuorumPct: uint64, _voteTime: uint64,  tx_params) -> None: ...
    def newVote(self, _executionScript: bytes, _metadata: string, _castVote: bool, _executesIfDecided: bool,  tx_params) -> uint256: ...
