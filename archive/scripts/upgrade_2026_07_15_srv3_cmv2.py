...
* Upgrade Lido Core contracts to enable SRv3, reassign roles and permissions, set Triggerable Withdrawals Gateway (TWG) exit limits, and register [CircuitBreaker Committee](https://docs.lido.fi/multisigs/emergency-brakes#11-circuitbreaker-committee) as the pauser for the new Consolidation Gateway and TopUp Gateway sealables. Items 1.2 - 1.19.
...
* Finalize the upgrade and validate target state. Item 1.69.
