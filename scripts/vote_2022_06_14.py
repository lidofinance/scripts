...
def encode_set_last_deposit_block(
    new_dsm_address: str, last_deposit_block: int
) -> Tuple[str, str]:
    ...
    return agent_forward(
        [
            (
                ...
                deposit_security_module.setLastDepositBlock.encode_input(
                    last_deposit_block
                ),
            )
        ]
...
def start_vote(
    ...
    current_deposit_security_module_address = (
        "0xDb149235B6F40dC08810AA69869783Be101790e7"
    )
    proposed_deposit_security_module_address = (
    ...
    call_script_items = [
        ...
        # 3. Set lastDepositBlock of DepositSecurityModule to 14985614
        encode_set_last_deposit_block(
            proposed_deposit_security_module_address, last_deposit_block
        ),
    ]
