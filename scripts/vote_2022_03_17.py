...
1. Send 722,962 LDO to finance multisig 0x48F300bD3C52c7dA6aAbDE4B683dEB27d38B9ABbfor 17th period referral rewards
2. Send 3,896 LDO to finance multisig 0x48F300bD3C52c7dA6aAbDE4B683dEB27d38B9ABb for 10,000 DAI Isidoros Passadis March comp
3. Send 6,493 LDO to finance multisig 0x48F300bD3C52c7dA6aAbDE4B683dEB27d38B9ABb for 16,666 DAI Jacob Blish March comp
"""
...
def start_vote(
    ...
    return confirm_vote_script(encoded_call_script, silent) and create_vote(
        vote_desc=(
            ...
            '2) Allocate 3,896 LDO tokens to Master of Validators March 2022 compensation;'
            '3) Allocate 6,493 LDO tokens to BizDev Leader March 2022 compensation;'
