...
def start_vote(tx_params, silent=False):
    ...
    fund_sushi_call_script = make_fund_sushi_rewards_call_script(lido_finance_ops_multisig_address, ldo_for_rewards_in_wei, finance)
    ...
    call_script = [fund_sushi_call_script, increase_staking_facilities_limit, increase_dsrv_limit, increase_everstake_limit, increase_skillz_limit]
