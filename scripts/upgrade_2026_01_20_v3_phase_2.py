...
def get_vote_items() -> Tuple[List[str], List[Tuple[str, str]]]:
    ...
    dg_call_script = submit_proposals([
        (dg_items, "Activate Lido V3 Phase 2, raise CSM stake share limit to 7.5% and priority exit threshold to 9%, grant MANAGE_FRAME_CONFIG_ROLE on CS HashConsensus to TwoPhaseFrameConfigUpdate contract")
    ])
