...
1. Submit a Dual Governance proposal to replace four legacy GateSeals with CircuitBreaker 0x6019CB557978296BA3C08a7B73225C0975DFB2F7 per LIP-34

# ===== GateSeal 0x8A854C4E750CDf24f138f34A9061b2f556066912 (WithdrawalQueue) =====
...
# ===== GateSeal 0xA6BC802fAa064414AA62117B4a53D27fFfF741F1 (ValidatorsExitBusOracle, TriggerableWithdrawalsGateway) =====
...
# ===== GateSeal 0x881dAd714679A6FeaA636446A0499101375A365c (VaultHub, PredepositGuarantee) =====
...
# ===== GateSeal 0xE1686C2E90eb41a48356c1cC7FaA17629af3ADB3 (Community Staking Module stack) =====
...
DG_PROPOSAL_METADATA = (
    "Replace four GateSeals with CircuitBreaker "
    "0x6019CB557978296BA3C08a7B73225C0975DFB2F7 per LIP-34"
)
DG_SUBMISSION_DESCRIPTION = (
    "1. Submit a Dual Governance proposal to replace four GateSeals with "
    "CircuitBreaker 0x6019CB557978296BA3C08a7B73225C0975DFB2F7 per LIP-34"
)

IPFS_DESCRIPTION = """
Replace four GateSeals with CircuitBreaker 0x6019CB557978296BA3C08a7B73225C0975DFB2F7 per [LIP-34](https://github.com/lidofinance/lido-improvement-proposals/blob/develop/LIPS/lip-34.md) ([forum](https://research.lido.fi/t/circuitbreaker-programmable-panic-layer/11400)). For each pausable: revoke `PAUSE_ROLE` from the legacy GateSeal, grant it to CircuitBreaker, register the pausable on CircuitBreaker with the previous sealing committee as pauser.

1. **WithdrawalQueue GateSeal 0x8A854C4E750CDf24f138f34A9061b2f556066912**. Pauser: 0x8772E3a2D86B9347A2688f9bc1808A6d8917760C. Items 1.1-1.3.
2. **VEBO+TWG GateSeal 0xA6BC802fAa064414AA62117B4a53D27fFfF741F1**. Pauser: 0x8772E3a2D86B9347A2688f9bc1808A6d8917760C. Items 1.4-1.9.
3. **VaultHub+PredepositGuarantee GateSeal 0x881dAd714679A6FeaA636446A0499101375A365c**. Pauser: 0x8772E3a2D86B9347A2688f9bc1808A6d8917760C. Items 1.10-1.15.
4. **CSM GateSeal 0xE1686C2E90eb41a48356c1cC7FaA17629af3ADB3** (CSModule, CSAccounting, CSFeeOracle, CSVerifierV2, CSVettedGate, CSEjector). Pauser: 0xC52fC3081123073078698F1EAc2f1Dc7Bd71880f. Items 1.16-1.33.
"""
