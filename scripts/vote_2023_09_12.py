...
def start_vote(tx_params: Dict[str, str], silent: bool) -> bool | list[int | TransactionReceipt | None]:
    ...
    call_script_items = [
        ...
        encode_permission_create(entity="0x3c9AcA237b838c59612d79198685e7f20C7fE783", target_app="0x6370FA71b9Fd83aFC4196ee189a0d348C90E93b0", permission_name='MANAGE_SIGNING_KEYS', manager="0x3c9AcA237b838c59612d79198685e7f20C7fE783"),
        ...
        add_evmscript_factory(
            factory="0x56eC3C4CeF495C3CBaBdedfb73fd7cf4B8F5B437",
            permissions="0x6370FA71b9Fd83aFC4196ee189a0d348C90E93b0"+ contracts.node_operators_registry.updateTargetValidatorsLimits.signature[2:]
        ),
    ]
    ...
    vote_desc_items = [
        f"1) Init staking module",
            ...
            "SetNodeOperatorRewardAddresses deployed at: 0x2e565f073FeBD66cb24dD9CA66Bffe6CeFd0B7Af",
            "TransferNodeOperatorManager deployed at: 0x8A33BA98C7165BDb61af1468fd5BD8aF22B3d87d",
            "UpdateTargetValidatorLimits deployed at: 0x56eC3C4CeF495C3CBaBdedfb73fd7cf4B8F5B437",
