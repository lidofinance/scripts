...
def start_vote(tx_params, silent=False):
    ...
    fund_audit_call_script = make_fund_deversifi_call_script(lido_finance_ops_multisig_address,
                                                             ldo_for_deversifi_in_wei, finance)
    fund_referral_call_script = make_fund_curve_rewards_call_script(rewards_manager_address, ldo_for_rewards_in_wei,
                                                                    finance)
