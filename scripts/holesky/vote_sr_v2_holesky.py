...
def grantCsmResumeRoleToAgent() -> Tuple[str, str]:

    return (
        contracts.csm.address,
        contracts.csm.grantRole.encode_input(
...
def start_vote(tx_params: Dict[str, str], silent: bool) -> Tuple[int, Optional[TransactionReceipt]]:
    ...
    call_script_items = [
        ...
        # (
        #     contracts.csm.address,
        #     contracts.csm.revokeRole.encode_input(
        #         "0x2fc10cc8ae19568712f7a176fb4978616a610650813c9d05326c34abb62749c7", contracts.agent.address
        #     ),
        # ),
        # # 27)
        # (contracts.csmHashConsensus.address, contracts.csmHashConsensus.updateInitialEpoch(CS_ORACLE_INITIAL_EPOCH)),
        # 28)
    ]
