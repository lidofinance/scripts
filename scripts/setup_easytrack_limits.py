...
def start_vote(
    ...
    encoded_call_script = encode_call_script([
        encode_permission_revoke(finance, 'CREATE_PAYMENTS_ROLE', evmscriptexecutor),
        encode_permission_grant_p(finance, 'CREATE_PAYMENTS_ROLE', evmscriptexecutor, params=amount_limits())
    ])
