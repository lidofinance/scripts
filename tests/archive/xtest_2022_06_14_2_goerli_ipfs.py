"""
Tests for Voting 14/06/2022-2 [patch-2 for Goerli].
"""
import pytest

from brownie import interface

from scripts.vote_2022_06_14_2_goerli_ipfs import (
    start_vote,
...
def get_lido_app_old_content_uri():
    if network_name() in ('goerli', 'goerli-fork'):
        return '0x697066733a516d5552623557414c5147386232695775476d79476151376b593571357664346f4e4b355a56444c6a526a6a326d'
...
def get_lido_app_old_ipfs_cid():
    if network_name() in ('goerli', 'goerli-fork'):
        return 'QmURb5WALQG8b2iWuGmyGaQ7kY5q5vd4oNK5ZVDLjRjj2m'
    elif network_name() in ('mainnet', 'mainnet-fork'):
