...
LIDO_LEGACY_ORACLE_IMPL = "0xCb461e10f5AD0575172e7261589049e44aAf209B"
...
LIDO_BURNER = "0x0359bC6ef9425414f9b22e8c9B877080B52793F5"
LIDO_EXECUTION_LAYER_REWARDS_VAULT = "0x388C818CA8B9251b393131C08a736A67ccB19297"
LIDO_HASH_CONSENSUS_FOR_AO = "0x64bc157ec2585FAc63D33a31cEd56Cee4cB421eA"
LIDO_ACCOUNTING_ORACLE = "0x010ecB2Af743c700bdfAF5dDFD55Ba3c07dcF9Df"
LIDO_ACCOUNTING_ORACLE_IMPL = "0xE1987a83C5427182bC70FFDC02DBf51EB21B1115"
LIDO_HASH_CONSENSUS_FOR_VEBO = "0x8D108EB23306c9F860b1F667d9Fcdf0dA273fA89"
...
LIDO_EIP712_STETH = "0x075CEf9752b42e332Dab0bae1Ca63801AD8E28C7"
...
LIDO_WITHDRAWAL_VAULT_IMPL_V1 = "0xe681faB8851484B57F32143FD78548f25fD59980"
...
LIDO_ORACLE_DAEMON_CONFIG = "0xFc5768E73f8974f087c840470FBF132eD059aEbc"
...
def test_proxyfied_implementation_addresses_prepared():
    ...
    assert get_proxy_impl_ossifiable(config.LIDO_ACCOUNTING_ORACLE) != DUMMY_IMPL  # dummy
    assert get_proxy_impl_ossifiable(config.LIDO_VALIDATORS_EXIT_BUS_ORACLE) != DUMMY_IMPL  # dummy
    assert get_proxy_impl_ossifiable(config.LIDO_WITHDRAWAL_QUEUE) != DUMMY_IMPL  # dummy
    assert get_proxy_impl_ossifiable(config.LIDO_STAKING_ROUTER) != DUMMY_IMPL  # dummy


def test_proxyfied_implementation_addresses_after_upgrade(helpers):
    start_and_execute_votes(contracts.voting, helpers)
    assert get_proxy_impl_ossifiable(config.LIDO_LOCATOR) != LIDO_LOCATOR_IMPL
    assert get_proxy_impl_ossifiable(config.LIDO_ACCOUNTING_ORACLE) != LIDO_ACCOUNTING_ORACLE_IMPL
    assert get_proxy_impl_ossifiable(config.LIDO_VALIDATORS_EXIT_BUS_ORACLE) != LIDO_VALIDATORS_EXIT_BUS_ORACLE_IMPL
    assert get_proxy_impl_ossifiable(config.LIDO_WITHDRAWAL_QUEUE) != LIDO_WITHDRAWAL_QUEUE_IMPL
    assert get_proxy_impl_app(config.LIDO_WITHDRAWAL_VAULT) != LIDO_WITHDRAWAL_VAULT_IMPL
    assert get_proxy_impl_ossifiable(config.LIDO_STAKING_ROUTER) != LIDO_STAKING_ROUTER_IMPL
