...
from scripts.vote_hoodi_exit_hashes_2 import start_vote, EXIT_HASH_TO_SUBMIT
...
def test_vote_hoodi_exit_hashes(helpers, accounts, vote_ids_from_env, stranger):
    ...
    expected_events = 3  # 1 proxy upgrade + 2 role grants + 1 role grant for agent + 1 hash submission + 1 role revoke
    ...
    # Step 1: Grant SUBMIT_REPORT_HASH_ROLE to agent
    ...
    # Step 2: Submit exit requests hash
    ...
    # Step 3: Revoke SUBMIT_REPORT_HASH_ROLE from agent
