...
def test_legacy_oracle_report_skipped(helpers, vote_ids_from_env, accounts):
    ...
    with reverts("NON_EMPTY_DATA"):
        oracle_report(simulation_block_identifier=block_number_hour_before_upgrade)
    ...
    # oracle_report(simulation_block_identifier=block_number_23_hours_after_upgrade)
