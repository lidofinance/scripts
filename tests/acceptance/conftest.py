...
from utils.test.governance_helpers import execute_vote_and_process_dg_proposals_orderly # execute_vote_and_process_dg_proposals
...
def autoexecute_vote(module_isolation, helpers, vote_ids_from_env, dg_proposal_ids_from_env):
    ...
    execute_vote_and_process_dg_proposals_orderly(helpers)
