...
def test_emergency_protected_timelock_acceptance():
    ...
    assert ept.MAX_AFTER_SCHEDULE_DELAY() == EMERGENCY_PROTECTED_TIMELOCK_VALUES["MAX_AFTER_SCHEDULE_DELAY"] # 30 mins
    assert ept.MAX_AFTER_SUBMIT_DELAY() == EMERGENCY_PROTECTED_TIMELOCK_VALUES["MAX_AFTER_SUBMIT_DELAY"] # 30 mins
    assert ept.MAX_EMERGENCY_MODE_DURATION() == EMERGENCY_PROTECTED_TIMELOCK_VALUES["MAX_EMERGENCY_MODE_DURATION"] # 30 days
    assert ept.MAX_EMERGENCY_PROTECTION_DURATION() == EMERGENCY_PROTECTED_TIMELOCK_VALUES["MAX_EMERGENCY_PROTECTION_DURATION"] # 2 years
    assert ept.MIN_EXECUTION_DELAY() == EMERGENCY_PROTECTED_TIMELOCK_VALUES["MIN_EXECUTION_DELAY"] # 2 mins

    assert ept.getAfterScheduleDelay() == EMERGENCY_PROTECTED_TIMELOCK_VALUES["AFTER_SCHEDULE_DELAY"] # 2 mins
    assert ept.getAfterSubmitDelay() == EMERGENCY_PROTECTED_TIMELOCK_VALUES["AFTER_SUBMIT_DELAY"] # 2 mins
