...
class TestSubmitReportExtraDataList:
    ...
    def test_too_short_extra_data_item(self):
        extra_data = self.build_extra_data(
            [
                build_extra_data_item(0, ItemType.EXTRA_DATA_TYPE_EXITED_VALIDATORS, 1, [2], [2]),
                build_extra_data_item(1, ItemType.EXTRA_DATA_TYPE_EXITED_VALIDATORS, 2, [2], [2])[:36],
            ]
        )
        ...
        extra_data = self.build_extra_data(
            [
                build_extra_data_item(0, ItemType.EXTRA_DATA_TYPE_EXITED_VALIDATORS, 1, [2, 3, 4, 5], [2]),
                build_extra_data_item(1, ItemType.EXTRA_DATA_TYPE_EXITED_VALIDATORS, 2, [2], [2]),
            ]
        )
    ...
    def test_nos_count_zero(self):
        extra_data = self.build_extra_data(
            [
                build_extra_data_item(0, ItemType.EXTRA_DATA_TYPE_EXITED_VALIDATORS, 1, [2], [2]),
                build_extra_data_item(1, ItemType.EXTRA_DATA_TYPE_EXITED_VALIDATORS, 2, [], [1]),
            ]
        )
    ...
    def test_module_id_zero(self):
        extra_data = self.build_extra_data(
            [
                build_extra_data_item(0, ItemType.EXTRA_DATA_TYPE_EXITED_VALIDATORS, 1, [2], [2]),
                build_extra_data_item(1, ItemType.EXTRA_DATA_TYPE_EXITED_VALIDATORS, 0, [2], [1]),
            ]
        )
    ...
    def test_unexpected_extra_data_index(self):
        ...
        extra_data = self.build_extra_data(
            [
                build_extra_data_item(0, ItemType.EXTRA_DATA_TYPE_EXITED_VALIDATORS, 1, [2], [1]),
                build_extra_data_item(3, ItemType.EXTRA_DATA_TYPE_EXITED_VALIDATORS, 1, [2], [1]),
            ]
        )
    ...
    def test_invalid_extra_data_sort_order_on_stuck(self):
        ...
        extra_data = self.build_extra_data(
            [
                build_extra_data_item(0, ItemType.EXTRA_DATA_TYPE_EXITED_VALIDATORS, module_id, unsorted_operator_ids, new_stuck_keys),
            ]
        )
