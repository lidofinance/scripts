...
def assure_depositable_keys(stranger):
    ...
    if not modules[3].depositable_keys:
        random_address = "0x00200f4e638e81ebe172daa18c9193a33a50bbbd"
        csm_add_node_operator(contracts.csm, contracts.cs_permissionless_gate, contracts.cs_accounting, random_address, keys_count=1)
